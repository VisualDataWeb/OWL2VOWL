 ...
 *
 */
public class TestEquivalentVisitor implements OWLObjectVisitor {
	private OWLObject entity;
	private OntologyInformation ontologyInformation;
	private ElementFinder finder;
	private int index;

	public TestEquivalentVisitor (OWLObject entity, OntologyInformation ontologyInformation, ElementFinder finder, int index) {
		this.entity = entity;
